    ...
    methods:{
      ...
      getoneday(){
        axios.get('/sensor/distance/distance0001/datas',{params:{starttime:this.today.start,endtime:this.today.end}}).then(res=>{
          ...
          this.datavalue.splice(0,this.datavalue.length)
          this.setdata()
          // console.log(this.temperaturestarget.sumdata)
          // console.log(this.temperaturestarget.detection)
          // console.log(this.temperaturestarget.misdetection)
          // console.log(this.temperaturestarget.undetection)
          this.chartLine.setOption(this.option);
          this.quote();
        })
      }
